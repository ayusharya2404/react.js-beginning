...
const SignupSchema = Yup.object().shape({
  ...
  .matches(/[a-z]/ ,'Lower is required')
  .matches(/[A-Z]/ ,'Upper is required')
  .matches(/[a-z]/ ,'Lower is required')
...
const signup = () => {
  ...
  return (
    <div className="mt-7 max-w-lg mx-auto bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-600 dark:border-neutral-700">
      ...
      <div className="mt-5">
        ...
        <form onSubmit={signupForm.handleSubmit}>
          <div className="grid gap-y-4">
            ...
            >
              {
                signupForm.isSubmitting ? (<Cardio
                  size="30"
                  stroke="4"
                  speed="2"
                  color="white" 
